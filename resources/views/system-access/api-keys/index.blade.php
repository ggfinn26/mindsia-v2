            ...
            <table class="table-auto w-full">
                <thead class="text-xs font-semibold uppercase text-gray-500 bg-gray-50 border-t border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left">Token (Hidden)</th>
                        <th class="px-6 py-3 text-left">Dibuat Oleh</th>
                        <th class="px-6 py-3 text-left">Terakhir Digunakan</th>
                        <th class="px-6 py-3 text-right">Aksi</th>
                    </tr>
                </thead>
                <tbody class="text-sm divide-y divide-gray-200">
                    <tr>
                        <td colspan="5" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">Belum ada API Key.</td>
                    </tr>
                </tbody>
            </table>
        </div>
