...
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-4xl mx-auto">
    <div class="mb-8">
        <h1 class="text-2xl md:text-3xl text-gray-800 font-bold">Upload Materi Pembelajaran</h1>
    </div>
    ...
    <div class="bg-white shadow-lg rounded-sm border border-gray-200">
        <form action="#" method="POST" enctype="multipart/form-data" class="p-6 space-y-4">
            ...
            <div>
                <label class="block text-sm font-medium mb-1">File Materi (PDF, PPT, DOC, Video) <span class="text-red-500">*</span></label>
                <input type="file" name="file" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100" required />
            </div>
            ...
            <div class="mt-8 flex justify-end">
                ...
                <button type="submit" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">Upload Materi</button>
            </div>
        </form>
    </div>
</div>
