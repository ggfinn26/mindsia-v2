...
<head>
    ...
    <title>429 — Slow Down | MINDSIA</title>
...
<body class="min-h-screen bg-[#F8FAFC] text-[#111827] font-inter antialiased flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-xl">
            ...
            <div class="px-8 py-8">
                ...
                <div class="flex items-start justify-between mb-6">
                    <div>
                        ...
                        <p class="font-jakarta font-extrabold text-[56px] leading-none text-[#5586DB]">429</p>
                    </div>
                    <div class="text-right">
                        <p class="text-[11px] font-bold uppercase tracking-widest text-[#9CA3AF] mb-1">Participation</p>
                        <p class="font-jakarta font-extrabold text-[24px] leading-none text-amber-400 mt-2">Too much</p>
                        <p class="text-[11px] text-[#9CA3AF]">Let others speak.</p>
                    </div>
                </div>
                ...
                <div class="border-t border-dashed border-[#E5E7EB] pt-6 mb-6">
                    ...
                    <p class="text-[14px] text-[#4B5563] leading-relaxed">
                        You're sending too many requests — like the student who answers every question before the teacher finishes asking it. Eager is good. This is too much. Take a breath and try again in a moment.
                    </p>
                </div>

                <div class="bg-[#F8FAFC] border border-[#E5E7EB] rounded-xl px-5 py-4 mb-8">
                    <p class="text-[13px] text-[#111827]">
                        <span class="font-bold">throttled</span>
                        <span class="text-[#9CA3AF] text-[12px] mx-1">/ˈθrɒt.əld/</span>
                        <span class="italic text-[#9CA3AF] text-[12px]">verb, past tense</span>
                    </p>
                    <p class="text-[13px] text-[#4B5563] mt-1">
                        <span class="font-bold">1.</span> Slowed down by force. What happens when you use "very very very" instead of a stronger adjective. Also: what our server just did to you.
                    </p>
                </div>
        ...
        <p class="text-center text-[12px] text-[#9CA3AF] mt-5 font-medium">
            "Patience is a virtue — and also a B2 vocabulary word." ✦
        </p>
