...
<head>
    ...
    <title>503 — We're in Class | MINDSIA</title>
...
<body class="min-h-screen bg-[#F8FAFC] text-[#111827] font-inter antialiased flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-xl">
            ...
            <div class="px-8 py-8">
                ...
                <div class="flex items-start justify-between mb-6">
                    <div>
                        ...
                        <p class="font-jakarta font-extrabold text-[56px] leading-none text-[#5586DB]">503</p>
                    </div>
                    <div class="text-right">
                        <p class="text-[11px] font-bold uppercase tracking-widest text-[#9CA3AF] mb-1">Availability</p>
                        <p class="font-jakarta font-extrabold text-[24px] leading-none text-amber-400 mt-2">In Class</p>
                        <p class="text-[11px] text-[#9CA3AF]">Please wait outside.</p>
                    </div>
                </div>
                ...
                <div class="border-t border-dashed border-[#E5E7EB] pt-6 mb-6">
                    ...
                    <h1 class="font-jakarta font-extrabold text-[22px] text-[#111827] mb-3 leading-snug">
                        "We are currently in a lesson. Please come back shortly."
                    </h1>
                    <p class="text-[14px] text-[#4B5563] leading-relaxed">
                        The service is temporarily unavailable — like the teacher who put a "Do Not Disturb" sign on the classroom door. We're doing maintenance. Use this time to review your vocabulary.
                    </p>
                </div>
                ...
                <div class="bg-[#F8FAFC] border border-[#E5E7EB] rounded-xl px-5 py-4 mb-8">
                    <p class="text-[13px] text-[#111827]">
                        ...
                        <span class="text-[#9CA3AF] text-[12px] mx-1">/ˌʌn.əˈveɪ.lə.bəl/</span>
                        <span class="italic text-[#9CA3AF] text-[12px]">adjective</span>
                    </p>
                    <p class="text-[13px] text-[#4B5563] mt-1">
                        <span class="font-bold">1.</span> Not able to be used or obtained at this time.
                        <span class="italic text-[#9CA3AF]">Usage: "The server is unavailable." "The teacher is unavailable." "My motivation on Monday mornings is unavailable."</span>
                    </p>
                </div>

                @isset($exception)
                    @if($exception->getMessage())
                        <div class="bg-amber-50 border border-amber-200 rounded-xl px-5 py-3 mb-6">
                            <p class="text-[12px] font-bold text-amber-700 uppercase tracking-widest mb-1">Maintenance Note</p>
                            <p class="text-[13px] text-amber-700">{{ $exception->getMessage() }}</p>
                        </div>
                    @endif
                @endisset
        ...
        <p class="text-center text-[12px] text-[#9CA3AF] mt-5 font-medium">
            "Good things come to those who wait — and also to those who study while waiting." ✦
        </p>
