...
<head>
    ...
    <title>500 — Server Error | MINDSIA</title>
...
<body class="min-h-screen bg-[#F8FAFC] text-[#111827] font-inter antialiased flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-xl">
            ...
            <div class="px-8 py-8">
                ...
                <div class="flex items-start justify-between mb-6">
                    <div>
                        ...
                        <p class="font-jakarta font-extrabold text-[56px] leading-none text-[#5586DB]">500</p>
                    </div>
                    <div class="text-right">
                        <p class="text-[11px] font-bold uppercase tracking-widest text-[#9CA3AF] mb-1">Essay Grade</p>
                        <p class="font-jakarta font-extrabold text-[24px] leading-none text-red-400 mt-2">Incomplete</p>
                        <p class="text-[11px] text-[#9CA3AF]">Needs revision.</p>
                    </div>
                </div>
                ...
                <div class="border-t border-dashed border-[#E5E7EB] pt-6 mb-6">
                    ...
                    <h1 class="font-jakarta font-extrabold text-[22px] text-[#111827] mb-3 leading-snug">
                        "The server tried its best. It was not enough."
                    </h1>
                    <p class="text-[14px] text-[#4B5563] leading-relaxed">
                        Something broke on our end — like a student who studied all night but still wrote "their" instead of "there" in the final exam. It's our fault, not yours. We'll fix it.
                    </p>
                </div>
                ...
                <div class="bg-[#F8FAFC] border border-[#E5E7EB] rounded-xl px-5 py-4 mb-8">
                    <p class="text-[13px] text-[#111827]">
                        ...
                        <span class="text-[#9CA3AF] text-[12px] mx-1">/ˈer.ər/</span>
                        <span class="italic text-[#9CA3AF] text-[12px]">noun</span>
                    </p>
                    <p class="text-[13px] text-[#4B5563] mt-1">
                        <span class="font-bold">1.</span> A mistake. Everyone makes them — students, teachers, and apparently, servers.
                        <span class="italic text-[#9CA3AF]">See also: typo, blunder, our bad.</span>
                    </p>
                </div>
        ...
        <p class="text-center text-[12px] text-[#9CA3AF] mt-5 font-medium">
            "Making mistakes is how you learn. The server is learning." ✦
        </p>
