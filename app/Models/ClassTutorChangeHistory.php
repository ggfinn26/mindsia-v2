...
class ClassTutorChangeHistory extends Model
{
    ...
    public function fromTutor(): BelongsTo { return $this->belongsTo(Employee::class, 'from_tutor_id'); }
    public function toTutor(): BelongsTo { return $this->belongsTo(Employee::class, 'to_tutor_id'); }
    public function changedBy(): BelongsTo { return $this->belongsTo(Employee::class, 'changed_by_employee_id'); }
}
