...
class MemberClass extends Model
{
    ...
    public function memberRegistration(): BelongsTo { return $this->belongsTo(Member::class, 'member_registration_id'); }
    public function classRoom(): BelongsTo { return $this->belongsTo(ClassRoom::class, 'class_id'); }
    public function curriculumProgress(): HasMany { return $this->hasMany(MemberCurriculumProgress::class, 'member_class_id'); }
}
