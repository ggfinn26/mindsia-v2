...
export class CircularGalleryApp {
  constructor(container, { items, bend, textColor, borderRadius, font, scrollSpeed, scrollEase, autoPlay, autoPlaySpeed }) {
    ...
    this.autoPlaySpeed = autoPlaySpeed || 1.5;
    this.onCheckDebounce = debounce(this.onCheck.bind(this), 200);
    this.items = items;
    this.bend = bend !== undefined ? bend : 3;
  ...
  update() {
    if (this.autoPlay && !this.isDown) {
        this.scroll.target -= this.autoPlaySpeed; // Negative to move items to the left (forward)
    }
